...
WIDTH = 750 #original WIDTH: 640
HEIGHT = 580 #original HEIGHT: 464
FPS = 30
BGCOLOR = BLACK
WINDOW_TITLE = "Coding4Everybody - Street Fighter"

GROUND_LEVEL = HEIGHT - 220 #original GROUND_LEVEL: 268
...
HEALTH_BAR_HEIGHT = int(WIDTH / 20)
HEALTH_BAR_AMPLIFIER = int(WIDTH / 300)
HEALTH_BAR_BORDER_WIDTH = 5
HEALTH_BAR_OLD_HEALTH_DELAY = 20
HEALTH_BAR_OLD_HEALTH_DECREASE_SPEED = 3
HEALTH_BAR_PLAYER_1_START_X = int(WIDTH / 9)
HEALTH_BAR_PLAYER_1_START_Y = int(WIDTH / 25)
HEALTH_BAR_PLAYER_2_START_X = int((5 * WIDTH) / 9)
HEALTH_BAR_PLAYER_2_START_Y = int(WIDTH / 25)
